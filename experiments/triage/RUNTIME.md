...
joint-thread artifacts. `tether.nix` pins the approved candidate's immutable runtime;
see [production identities and rollback](v2j/PRODUCTION.md) and [architecture](JOINT.md).
